...
.. note::
   ...
   The tutorial was prepared for Ubuntu Linux, but it works on MacOS, other Linuxes
   and on Windows-based terminals such as **Git Bash** and **WSL2** as well.
...
.. topic:: License
   ...
   **© 2024 Dr. Kristian Rother (`kristian.rother@posteo.de`)**
   ...
   `https://github.com/krother/bash_tutorial <https://github.com/krother/bash_tutorial>`__

.. |image0| image:: images/tux.png
